...
import type {
  Step1Data,
  Step2Data,
} from "../../presentation/schemas/pickup-validation-schemas"
 ...
 */
export interface PickupCalendarFormData {
  step1: Step1Data
  step2: Step2Data
}
 ...
 * État du formulaire
 */
interface PickupCalendarFormState {
  formData: PickupCalendarFormData
 ...
 */
interface PickupCalendarFormActions {
  // Données
  updateStep1Data: (data: Partial<PickupCalendarFormData["step1"]>) => void
  updateStep2Data: (data: Partial<PickupCalendarFormData["step2"]>) => void
...
const stepsConfig: StepConfig[] = [
  {
    id: 1,
    name: "informations",
    path: "/calendars/pickup/create/informations",
    title: "Informations de l'enlèvement",
    isOptional: false,
    isCompleted: false,
  },
  {
    id: 2,
    name: "summary",
    path: "/calendars/pickup/create/summary",
    title: "Récapitulatif",
    isOptional: false,
    isCompleted: false,
  },
 ...
 * Données par défaut
 */
const defaultFormData: PickupCalendarFormData = {
  step1: {
    opaId: "",
    conventionId: "",
    startDate: "",
 ...
 */
const initialState: PickupCalendarFormState = {
...
/**
 * Store Zustand pour le formulaire de création de calendrier ENLEVEMENT
 */
export const usePickupAddFormStore = create<
  PickupCalendarFormState & PickupCalendarFormActions
>()(
  persist(
    (set, get) => ({
      // État initial
    ...
    {
      name: "pickup-calendar-form-storage",
      ...
      partialize: (state) =>
        ...
        } as unknown as PickupCalendarFormState & PickupCalendarFormActions),
