...
import { useMarketAddFormNavigation } from "../../../hooks/useMarketAddFormNavigation";
import {
  createStep1Schema,
  type Step1Data,
} from "../../../schemas/market-validation-schemas";
import { MarketFormLayout } from "../MarketFormLayout";

export function MarketAddStep1() {
  ...
  const { navigateToNext } = useMarketAddFormNavigation();
  ...
  const headerContent = (
    <div className="flex items-center space-x-3">
      <h1 className="text-xl font-medium text-gray-900">
        {t("calendar:forms.marketAdd.step1.sectionTitle")}
      </h1>
    </div>
  );

  return (
    <MarketFormLayout className="lg:flex items-start lg:space-x-4">
