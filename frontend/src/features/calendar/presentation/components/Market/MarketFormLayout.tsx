...
interface MarketFormLayoutProps {
...
export function MarketFormLayout({
  children,
  className,
  onHandleCancel,
  title,
}: MarketFormLayoutProps) {
  ...
  const pageTitle =
    title || (isEditMode ? t("forms.marketAdd.editTitle") : t("forms.marketAdd.createTitle"));
