/**
 * Types et codes d'erreur spécifiques à l'authentification pour l'application ONCC
 */
...
export const AuthErrorMessages: Record<AuthErrorCodes, string> = {
  ...
  [AuthErrorCodes.LOGIN_ACCOUNT_BLOCKED]:
  ...
  [AuthErrorCodes.OTP_SESSION_INVALID]:
  ...
  // Mot de passe
  [AuthErrorCodes.PASSWORD_CHANGE_CURRENT_INVALID]:
  ...
  [AuthErrorCodes.PASSWORD_FORGOT_EMAIL_NOT_FOUND]:
    "Aucun compte associé à cette adresse email",
  [AuthErrorCodes.PASSWORD_FORGOT_SEND_FAILED]:
  ...
  [AuthErrorCodes.SECURITY_QUESTIONS_NOT_FOUND]:
    "Questions de sécurité non trouvées",
...
export const AuthSuccessMessages: Record<AuthSuccessCodes, string> = {
  ...
  [AuthSuccessCodes.SECURITY_QUESTIONS_SETUP]:
