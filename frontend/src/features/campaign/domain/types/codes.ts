/**
 * Codes d'erreur spécifiques aux campagnes (Frontend)
 * Synchronisés avec les codes d'erreur backend
 */
...
export const CampaignErrorMessages: Record<CampaignErrorCodes, string> = {
  ...
  [CampaignErrorCodes.CAMPAIGN_CREATION_FAILED]:
    "Échec de la création de la campagne.",
  [CampaignErrorCodes.CAMPAIGN_UPDATE_FAILED]:
    "Échec de la mise à jour de la campagne.",
  [CampaignErrorCodes.CAMPAIGN_ACTIVATION_FAILED]:
    "Échec de l'activation de la campagne.",
  [CampaignErrorCodes.CAMPAIGN_DEACTIVATION_FAILED]:
    "Échec de la désactivation de la campagne.",
  ...
  [CampaignErrorCodes.CAMPAIGN_LIST_FAILED]:
    "Échec de la récupération de la liste des campagnes.",
  [CampaignErrorCodes.CAMPAIGN_NOT_AUTHORIZED]:
    "Vous n'êtes pas autorisé à effectuer cette action.",
  [CampaignErrorCodes.CAMPAIGN_NO_ACTIVE]:
    "Aucune campagne active n'est disponible.",
};
...
export const CampaignSuccessMessages: Record<CampaignSuccessCodes, string> = {
  ...
  [CampaignSuccessCodes.CAMPAIGN_DEACTIVATED]:
    "Campagne désactivée avec succès.",
  [CampaignSuccessCodes.CAMPAIGN_LIST_SUCCESS]:
    "Liste des campagnes récupérée avec succès.",
  [CampaignSuccessCodes.CAMPAIGN_FETCH_SUCCESS]:
