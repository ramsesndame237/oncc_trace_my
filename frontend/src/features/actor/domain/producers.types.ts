...
// ===== TYPES POUR LE FORMULAIRE OPA =====

/**
 * Interface pour les données complètes du formulaire OPA
 */
export interface ProducersFormData {
  step1: Step1OPAInfoData;
  step2: Step2ManagerInfoData;
  step3: Step3MembersData;
...
/**
 * Interface du store pour le formulaire OPA multi-pages
 */
export interface ProducersFormStore {
  // Données du formulaire par étape
  formData: ProducersFormData;
  ...
  updateStep1Data: (data: Partial<Step1OPAInfoData>) => void;
  updateStep2Data: (data: Partial<Step2ManagerInfoData>) => void;
  updateStep3Data: (data: Partial<Step3MembersData>) => void;
